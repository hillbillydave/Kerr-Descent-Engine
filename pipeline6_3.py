...
# ============================================================
#  PIPELINE 6.3 — Autonomous Post-Throat Explorer
#  A: Free continuation
#  B: Bounce model
#  C: Tunneling model
...
steps_post = 20000      # steps after throat
r0 = 10.0

alpha = 0.00035
beta = 0.00012  # kept for future use if needed
...
# ============================================================
#  Pre-throat descent (same for all paths)
# ============================================================
def run_pre_throat():
    r_vals = []
    depth_vals = []
...
def main():
    ...
    # Combined manifold continuation map
    plt.figure(figsize=(10, 5))
    for mode in ["A", "B", "C"]:
        r, _, _ = paths[mode]
